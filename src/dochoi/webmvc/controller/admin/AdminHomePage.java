...
public class AdminHomePage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("prodcutHighestQuantity", prodcutHighestQuantity);
		  ...
		  request.setAttribute("transactions_ToDay",formatNumberWithCommas(
		  transactions_ToDay) );
		  request.setAttribute("transactions_Yesterday",formatNumberWithCommas(
		  transactions_Yesterday) );
		  request.setAttribute("transactions_ThatMonth",formatNumberWithCommas(
		  transactions_ThatMonth) );
		  request.setAttribute("transactions_LastMonth",formatNumberWithCommas(
		  transactions_LastMonth) );
